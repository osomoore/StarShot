...
CAPTAINS: tuple[Captain, ...] = (
    ...
    Captain("danny_davos", 'Danny "Drifter" Davos', "Drifter", "Before vaults score in Cleanup, drift 2 tiles straight forward."),
    ...
    Captain("beto_briego", 'Beto "Golden" Briego', "Golden", "+1 VP and +1 Desperation card from Vaults."),
...
STARFALLS: tuple[Starfall, ...] = (
    ...
    Starfall("stars_align", "Stars Align", "Roll a d6, rerolling 6s. The matching round's Vaults open this round.", "align"),
    Starfall("take_cover", "Take Cover", "At the end of this round, deal 2 damage to all players outside of a Vault's range.", "cover"),
    Starfall("golden_bounty", "Golden Bounty", "This turn, first hits during each Action gain 1 additional VP.", "gold"),
    Starfall("most_dangerous_game", "Most Dangerous Game", "All Vaults 1-5 open this round.", "danger"),
